...
// Find a matching campaign profile based on profile received
const matchCampaignProfile = (receivingProfile, profilesArray) => {
	return profilesArray.find((profile) => {
    return profile.id === receivingProfile.parentId;
  });
}

module.exports = { isValidProfile, getProfileById, getCurrencyByProfile, matchCampaignProfile }